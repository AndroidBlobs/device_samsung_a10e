...
PRODUCT_COPY_FILES += \
    ...
    frameworks/native/data/etc/vendor/etc/carrier/XAA/permissions/android.hardware.telephony.cdma.xml:$(TARGET_COPY_OUT_VENDOR)/etc/permissions/vendor/etc/carrier/XAA/permissions/android.hardware.telephony.cdma.xml \
...
# Inherit vendor
$(call inherit-product, vendor/samsung/a10e/a10e-vendor.mk)